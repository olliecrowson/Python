...
class AdjacencyList(object):
    def __init__(self):
        self.Node_Connections = {}  # must use dictionary. Dont use list of dicts! Use dict of dicts!
    ...
    def AddToDict(self, NodeFrom, NodeTo, x1, y1):
        ...
        for temp_nodes in self.temporary_nodes:
            for node_from_key, node_to_values in self.Node_Connections.items():
                if temp_nodes[0] in node_to_values:
                    self.Node_Connections[node_from_key].append(temp_nodes[1])
                elif temp_nodes[1] in node_to_values:
                    self.Node_Connections[node_from_key].append(temp_nodes[0])
